...
//     * @return
//     */
//    public static CommonResponse formatToPojo(String jsonData, Class<?> clazz) {
//        try {
//            if (clazz == null) {
//                return MAPPER.readValue(jsonData, CommonResponse.class);
//            }
...
//     * @return
//     */
//    public static CommonResponse format(String json) {
//        try {
//            return MAPPER.readValue(json, CommonResponse.class);
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
//        return null;
...
//     * @return
//     */
//    public static CommonResponse formatToList(String jsonData, Class<?> clazz) {
//        try {
//            JsonNode jsonNode = MAPPER.readTree(jsonData);
//            JsonNode data = jsonNode.get("data");
//            Object obj = null;
